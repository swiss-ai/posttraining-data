...
Uses schema files generated by schema_extract_newformat.py.
"""
...
def save_normalized_dataset(dataset: Dataset, output_path: Path, 
    ...
    metadata = {
        ...
        "script": "schema_normalize_newformat.py",
...
Examples:
  ...
  venv/bin/python 05-annotations/schema_normalize_newformat.py \\
  ...
  venv/bin/python 05-annotations/schema_normalize_newformat.py \\
    ...
    parser.add_argument(
        "--schema-dir",
        required=True,
        help="Directory containing schema files from schema_extract_newformat.py"
    )
    parser.add_argument(
        "--num-proc",
        type=int,
...
def main():
    ...
    if not unified_schema_file.exists():
        ...
        print(f"Run schema_extract_newformat.py first to generate schema files.")
        sys.exit(1)
