...
def save_dataset_and_metadata(dataset_dict: DatasetDict, output_path: Path, 
    ...
    processing_entry = {
        "operation": "boxed_answer_extraction_newformat",
        "script": "extract_boxed_answers_newformat.py",
...
Examples:
  ...
  venv/bin/python 05-annotations/extract_boxed_answers_newformat.py \\
    /capstor/store/cscs/swissai/infra01/posttrain_data/05_annotated_newformat/tulu-3-sft-olmo-2-mixture-0225-ai2-adapt-dev_numinamath_tir_math_decontaminated-toolExtracted \\
