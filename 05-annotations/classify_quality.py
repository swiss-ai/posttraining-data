...
Evaluates the quality of initial prompts in chat format datasets (with parts structure)
across four dimensions: well-formedness, clarity of intent, answerable scope, and completeness.
...
class QualityClassifier(BaseClassifier):
    ...
    def __init__(self):
        super().__init__(
            ...
            description="Evaluate question quality in chat format datasets (with parts structure)"
        )
