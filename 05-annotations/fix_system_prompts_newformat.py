...
def save_dataset_and_metadata(dataset_dict: DatasetDict, output_path: Path, 
    ...
    processing_entry = {
        ...
        "script": "fix_system_prompts_newformat.py",
...
Examples:
  ...
  venv/bin/python 05-annotations/fix_system_prompts_newformat.py \\
    /capstor/store/cscs/swissai/infra01/posttrain_data/04_decontaminated_newformat/smoltalk2-smoltalk_smollm3_systemchats_30k_no_think \\
  ...
  venv/bin/python 05-annotations/fix_system_prompts_newformat.py \\
    data/02-standardised_newformat/dataset-with-bad-prompts \\
  ...
  venv/bin/python 05-annotations/fix_system_prompts_newformat.py \\
    data/02-standardised_newformat/test-dataset \\
