...
def save_with_metadata(dataset, output_path: Path, input_path: Path, 
    ...
    processing_entry = {
        ...
        "script": "license_filter_newformat.py",
...
Examples:
  python license_filter_newformat.py data/02-standardised-newformat/tulu-3-sft-mixture
  python license_filter_newformat.py data/02-standardised-newformat/smoltalk --output data/03-license-filtered-newformat/smoltalk
  python license_filter_newformat.py data/02-standardised-newformat/Llama-Nemotron-Post-Training-Dataset --chunk-size 50000
  python license_filter_newformat.py --list-filters
        """
    )
